        ...
        >
          <View style={styles.welcomeSection}>
            {connected && walletAddress ? (
              ...
              <>
                <Text style={styles.welcomeTitle}>Welcome to Jupiter</Text>
                <Text style={styles.welcomeSubtitle}>Fund your account to get started.</Text>
              </>
            )}
...
const styles = StyleSheet.create({
  ...
  balancePillLiquid: {
    ...
    backgroundColor: 'rgba(0, 194, 176, 0.08)',
  },
  balancePillLocked: {
    borderColor: COLORS.brandPrimary,
    backgroundColor: 'rgba(0, 194, 176, 0.08)',
  ...
  pnlRow: {
    ...
    width: width - 32,
    borderWidth: 1,
    borderColor: 'rgba(0, 194, 176, 0.20)',
  },
  pnlLabel: {
    fontSize: 14,
    fontFamily: TYPOGRAPHY.fontFamilyBold,
  ...
  cardIconCircle: {
    ...
    height: 44,
    borderRadius: 14,
    backgroundColor: 'rgba(0, 194, 176, 0.15)',
    justifyContent: 'center',
    alignItems: 'center',
  },
  cardTitle: {
