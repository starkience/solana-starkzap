...
const styles = StyleSheet.create({
  ...
  tabActive: { backgroundColor: 'rgba(0, 194, 176, 0.12)', borderWidth: 1, borderColor: COLORS.brandPrimary },
  ...
  tokenSymbol: { fontSize: 14, fontFamily: TYPOGRAPHY.fontFamilyBold, color: COLORS.white },
  tokenName: { fontSize: 11, color: COLORS.textSecondary, fontFamily: TYPOGRAPHY.fontFamily },
  tokenPrice: { fontSize: 13, fontFamily: TYPOGRAPHY.fontFamilyMedium, color: COLORS.white, textAlign: 'right' },
  ...
  defiTitle: { fontSize: 18, fontFamily: TYPOGRAPHY.fontFamilyBold, color: COLORS.white, marginBottom: 16 },
  ...
  defiCardTitle: { fontSize: 14, fontFamily: TYPOGRAPHY.fontFamilyBold, color: COLORS.white },
